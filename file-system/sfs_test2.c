...
int main(int argc, char **argv)
{
    ...
    {
        printf("sfs_getnextfilename(filename) = %s\n", filename);
        printf("names[max] = %s\n", names[max]);
    ...
    int a;
    a = sfs_getnextfilename(filename);
    if(a)
    {
