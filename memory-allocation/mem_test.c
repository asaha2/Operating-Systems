...
int main(int argc, char* argv[]){
	...
	if(byteAllocTracker() == TEST_SIZE_2){
		printf("@test_success: remaining allocated bytes following deallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: remaining allocated bytes following deallocation does not match as expected!\n");
	}

	if(freeSpaceTracker() == (BLOCK_SIZE - TEST_SIZE_2)){
		printf("@test_success: free space cumulative size following deallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: free space cumulative size following deallocation does not match as expected!\n");
	}

	if(largeSpaceTracker() == (BLOCK_SIZE - (TEST_SIZE_1+TEST_SIZE_2+8))){
		printf("@test_success: largest contiguous free space following deallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: largest contiguous free space following deallocation does not match as expected!\n");
	}
	printf("=========================================================\n");
	...
	printf("buffer3: %p\n", buffer3);
	if(byteAllocTracker() == TEST_SIZE_1 + TEST_SIZE_2){
		printf("@test_success: total allocated bytes following reallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: total allocated bytes following reallocation does not match as expected!\n");
	}

	if(freeSpaceTracker() == (BLOCK_SIZE - (TEST_SIZE_1+TEST_SIZE_2+8))){
		printf("@test_success: total free space cumulative size following reallocation matches as expected!\n");
	} 
	else{
		printf("@test_success: total free space cumulative size following reallocation does not match as expected!\n");
	}

	if(largeSpaceTracker() == (BLOCK_SIZE - (TEST_SIZE_1+TEST_SIZE_2+8))){
		printf("@test_success: largest contiguous free space following reallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: largest contiguous free space following reallocation does not match as expected!\n");
	}
	printf("=========================================================\n");
	...
	if(byteAllocTracker() == TEST_SIZE_2){
		printf("@test_success: total allocated bytes following 2nd deallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: total allocated bytes following 2nd deallocation does not match as expected!\n");
	}

	if(freeSpaceTracker() == (BLOCK_SIZE - TEST_SIZE_2)){
		printf("@test_success: total free space cumulative size following 2nd deallocation matches as expected!\n");
	} 
	else{
		printf("@test_failure: total free space cumulative size following 2nd deallocation does not match as expected!\n");
	}
	...
	if(freeSpaceTracker() == (2*(BLOCK_SIZE)+8 - TEST_SIZE_3)){
		...
		printf("@test_failure: total free space cumulative size following deallocation does not match!\n");
	}
	...
	if(largeSpaceTracker() == (BLOCK_SIZE+8)){
		...
		printf("@test_failure: largest contiguous free space following deallocation does not match!\n");
	}
	printf("=========================================================\n");
